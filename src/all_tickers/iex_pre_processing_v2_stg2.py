...
iex_stg1_output_folder = 'C:\\uday\\ml_nlp_dsci\\datasets\\iex_finance\\day_trade_lstm\\output_v2\\stage1\\'
iex_stg2_output_folder = 'C:\\uday\\ml_nlp_dsci\\datasets\\iex_finance\\day_trade_lstm\\output_v2\\stage2\\'
output_file = 'ALL_TICKERS_STG2_ROB_MINMAX_OUT.CSV'
...
def process_stg1_output_files():
    ...
    for iex_stg1_file in iex_stg1_files:
        ...
        iex_stg1_df[columns_to_standardize] = RobustScaler().fit_transform(iex_stg1_df[columns_to_standardize])
        iex_stg1_df[columns_to_standardize] = MinMaxScaler().fit_transform(iex_stg1_df[columns_to_standardize])
